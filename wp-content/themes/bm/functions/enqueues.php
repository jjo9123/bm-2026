...
if ( ! function_exists('b4st_enqueues') ) {
    ...
    // Load SlickNav
    wp_enqueue_script( 'mobilenav-slickjs', get_template_directory_uri() . '/theme/js/jquery.slicknav.min.js', array('jquery-slicknav') );

    wp_register_style( 'slicknav-css', get_stylesheet_directory_uri() . '/theme/css/slicknav.css');
    wp_enqueue_style( 'slicknav-css' );
		...
		wp_register_script('slick-js', get_template_directory_uri() . '/theme/js/slick.min.js', false, null, true);
		wp_enqueue_script('slick-js');

		wp_register_script('b4st', get_template_directory_uri() . '/theme/js/b4st.js', false, null, true);
		wp_enqueue_script('b4st');

		// wp_register_script('cookie', get_template_directory_uri() . '/theme/js/cookie.js', false, null, true);
