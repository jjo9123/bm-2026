<div class="modal fade text-left" id="btn-customcta-modal-<?php echo get_the_ID(); ?>145" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="modal-copy">
          <h4 class="white"><?php the_field('heading', $mypost->ID); ?></h4>
        ...
        <div class="modal-form">
          <?php
            $form_object = get_field('form', $mypost->ID);
