...
?>
<section class="tabbed-navigation <?php if( get_sub_field('white_or_grey') == 'grey'): ?> grey<?php endif; ?>">
  <div class="container">
    <div class="row">

      <?php if ( get_sub_field('title') ) : ?>
        <div class="col-12 col-lg-12 mx-auto">
          <h2 class="purple text-left"><?php echo esc_html( get_sub_field('title') ); ?></h2>
        </div>
      <?php endif; ?>
