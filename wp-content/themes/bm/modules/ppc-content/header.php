          ...
          <div class="col-12">
            ...
            <?php if( $banner_section['add_button'] == 'yes' ):
                 ...
                 if( $banner_section['jump_to_bottom'] == 'yes' ): ?>
                   <a href="#contact-footer" class="btn btn-green header" tabindex="0"><?php echo $banner_section['btn_txt']; ?></a>
                  ...
                  <?php elseif( $banner_section['btn_choice'] == 'embed' ): ?>
                   ...
                   <?php elseif( $banner_section['btn_choice'] == 'external' ): ?>
                    <a href="<?php echo $banner_section['external_link']; ?>" target="_blank" class="btn btn-hero btn-green header" tabindex="0"><?php echo $banner_section['btn_txt']; ?></a>
    ...
    <section class="hero text-center" style="padding: 0;">
      <div class="video-container">
        ...
        <div class="poster hidden">
            <!-- <img src="hhttp://highcandi.com.gridhosted.co.uk/wp-content/uploads/2018/03/hero_vidcover.jpg" alt=""> -->
        </div>
      </div>
    </section>
