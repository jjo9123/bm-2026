<section class="txt <?php if( get_sub_field('left_or_centered') == 'center'): ?>text-center<?php endif; ?> <?php if( get_sub_field('background_colour') == 'grey'): ?> grey<?php endif; ?>" <?php if( get_sub_field('bg_choice') == 'img'): ?>style="background: url('<?php the_sub_field('bg_image'); ?>') 50% / cover no-repeat; color: #FFFFFF; "<?php endif; ?>>
  <div class="container">
    <div class="row">
