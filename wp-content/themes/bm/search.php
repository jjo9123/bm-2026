                        ...
                        <div class="row">
                          <div class="col-12 col-lg-10 mx-auto">
                            ...
                            <?php if( get_sub_field('add_button') == 'yes' ): ?>
                              <a href="<?php echo the_sub_field('button_link'); ?>" class="btn btn-green header" tabindex="0" data-name="<?php echo the_sub_field('title'); ?>"><?php echo the_sub_field('button_text'); ?></a>
                            <?php endif; ?>
                          </div>
                        </div>
                      </div>
