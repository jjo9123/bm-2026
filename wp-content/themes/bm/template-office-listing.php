...
<main id="main">
  <div id="content" role="main">
    ...
    <section class="hero text-center" style="background: url('/bm/wp-content/uploads/home/home_hero.jpg') 50% center / cover no-repeat; color: #fff;">
    ...
    <section class="map-section infographic text-center" style="background: url('/bm/wp-content/uploads/2019/02/offices-img-bg.jpg') 50% / cover no-repeat;">
      <div class="container">
        <div class="row">
          <div class="col-md-8 mx-auto">
